...
class ScoreTest {
    ...
    void compareTo() {
        ...
        Score score3 = new Score("Player3", 100);
    ...
    void testToString() {
        Score score = new Score("Player1", 100);
        assertEquals("Player1:100", score.toString(), "toString() should return 'Player1:100'.");
    }

    @Test
    void testEquals() {
        Score score1 = new Score("Player1", 100);
        Score score2 = new Score("Player1", 100);
        Score score3 = new Score("Player2", 200);
