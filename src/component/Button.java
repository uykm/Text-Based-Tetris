...
public class Button {
    static public JButton createLogoBtnNext(String btnName, String command, ActionListener listener, String iconPath) {
    ...
    static public JButton createLogoBtnUp(String btnName, String command, ActionListener listener, String iconPath) {
        JButton button = new JButton(btnName);
        button.setAlignmentX(Component.CENTER_ALIGNMENT); // Center align button
